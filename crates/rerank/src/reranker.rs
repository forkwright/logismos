//! Reranker trait and preflight implementations.
//!
//! Phase 5 Option A: contract only. [`GteReranker`] exists as a named
//! surface but every inference method fails loudly with a precise
//! [`Error::NotLoaded`].
