...
extern "C" __global__ void logismos_causal_conv_step_f32_kernel(
    const float*, const float*, const float*, float*, float*, std::uint32_t, std::uint32_t, std::uint32_t,
    std::uint32_t*);
...
extern "C" hipError_t logismos_launch_causal_conv_step_f32_checked(
    ...
    void* history_out_f32, void* output_f32, std::uint32_t token_count, std::uint32_t channel_count,
